...
| **Uji otomatis** | Suite unit/komponen API, web dan worker diperluas dalam [audit QA TCC 2026](docs/qa/AUDIT_TCC_2026.md). Angka terukur, cacat terbuka dan perintah reproduksi ada di [hasil pengujian](docs/qa/TEST_RESULTS.md). Worker mencapai 100% coverage sumber; seluruh proyek belum. Gate `pnpm test:regressions` memperlihatkan defect sebagai kegagalan, sehingga suite normal yang hijau tidak berarti seluruh flow sudah benar. SQL/PostGIS dan integrasi produksi masih memerlukan pengujian terpisah |
