...
export default function TenantMappingPage() {
  ...
  return (
    <div className="p-8 pb-20 max-w-4xl mx-auto relative min-h-full">
      ...
      <div className="mb-6">
        {method === "manual" ? (
          <div className="w-full h-[400px] rounded-2xl overflow-hidden relative border border-gray-200 bg-gray-100 shadow-inner">
            <div 
      ...
      <div className="flex items-center justify-between mt-auto">
        ...
        >
          <ArrowLeft className="w-4 h-4" /> Batal dan Kembali
        </Link>
        <button 
          onClick={() => router.push("/tenant/land/confirmation")}
