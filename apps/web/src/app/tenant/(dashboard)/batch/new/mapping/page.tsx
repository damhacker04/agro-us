...
export default function TenantBatchMappingPage() {
    ...
    <div className="p-8 pb-20 max-w-4xl mx-auto relative min-h-full">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-10 w-full relative">
        ...
        <div className="mb-10">
          ...
          <div className="mb-8">
            ...
            <div className="relative">
              <select defaultValue="1" className="w-full appearance-none border border-gray-300 rounded-xl px-4 py-3 text-sm font-bold text-gray-700 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-emerald-500 cursor-not-allowed">
          ...
          <div className="text-[10px] font-bold text-gray-500 mb-4 uppercase tracking-wider">
            Pilih petak lahan yang digunakan
          </div>
          ...
          <div className="mb-6">
            {method === "manual" ? (
              <div className="w-full h-[350px] rounded-2xl overflow-hidden relative border border-gray-200 bg-gray-100 shadow-inner">
                <div 
                ...
                >
                  {/* Dummy Big Polygon (Existing Land) */}
                  <svg className="absolute inset-0 w-full h-full" preserveAspectRatio="none">
                    <polygon points="100,100 600,120 750,250 150,280" fill="none" stroke="rgba(59, 130, 246, 0.8)" strokeWidth="2" strokeDasharray="4,4" />
                  </svg>
                  {/* Dummy Small Polygon (New Batch) */}
                  <svg className="absolute inset-0 w-full h-full" preserveAspectRatio="none">
                    <polygon points="400,150 600,200 500,260 350,220" fill="rgba(16, 185, 129, 0.3)" stroke="rgba(16, 185, 129, 0.8)" strokeWidth="2" />
                    <circle cx="400" cy="150" r="4" fill="white" stroke="rgba(16, 185, 129, 0.8)" strokeWidth="2" />
                    <circle cx="600" cy="200" r="4" fill="white" stroke="rgba(16, 185, 129, 0.8)" strokeWidth="2" />
                    <circle cx="500" cy="260" r="4" fill="white" stroke="rgba(16, 185, 129, 0.8)" strokeWidth="2" />
                    <circle cx="350" cy="220" r="4" fill="white" stroke="rgba(16, 185, 129, 0.8)" strokeWidth="2" />
                  </svg>
                </div>
        ...
        <div className="flex items-center justify-between mt-auto">
          ...
          >
            Lanjutkan ke Detail Batch <ArrowRight className="w-4 h-4" />
          </button>
        </div>
