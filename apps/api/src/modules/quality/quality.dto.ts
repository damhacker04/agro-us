...
import { IsInt, IsNumber, IsPositive, IsString, IsUUID, IsUrl, MaxLength, Min, MinLength } from "class-validator";
...
export class FileClaimDto {
  ...
  @IsUrl({}, { message: "photoUrl harus berupa URL foto barang" })
  photoUrl!: string;
